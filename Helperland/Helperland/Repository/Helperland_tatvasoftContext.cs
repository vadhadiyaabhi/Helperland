...
{
    public partial class Helperland_tatvasoftContext : DbContext
    {
        public Helperland_tatvasoftContext()
        {
        }

        public Helperland_tatvasoftContext(DbContextOptions<Helperland_tatvasoftContext> options)
            : base(options)
        {
        }
